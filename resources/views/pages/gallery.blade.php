...
<div class="bg-secondary pt-32 pb-16 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 xl:px-8 relative z-10 text-left text-white">
        <div class="flex flex-wrap items-center text-sm font-bold text-white/70 mb-10 space-x-2">
            ...
            <span>/</span>
            <span class="text-white font-black drop-shadow-sm">Galeri</span>
        </div>
        
        <div class="mb-5">
            <span class="bg-white/20 border border-white/40 text-white shadow-sm font-bold text-xs md:text-sm px-4 py-1.5 rounded-full uppercase tracking-wider">Momen Kawasan</span>
        </div>
        <h1 class="text-4xl md:text-5xl lg:text-7xl font-black mb-4 tracking-tight drop-shadow-md">Galeri & Pembangunan</h1>
        <p class="text-white/90 text-base md:text-lg max-w-2xl drop-shadow-sm">Visualisasi potret nyata kehidupan dan progres masif pembangunan kawasan Graha Land Serang yang terus bertumbuh pesat dan konsisten setiap harinya.</p>
    </div>
</div>
