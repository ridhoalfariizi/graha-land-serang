...
<div class="bg-secondary pt-32 pb-16 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 xl:px-8 relative z-10 text-left text-white">
        ...
        <div class="mb-5">
            <span class="bg-primary/20 border border-primary text-primary font-bold text-xs md:text-sm px-4 py-1.5 rounded-full uppercase tracking-wider">Keunggulan Klaster</span>
        </div>
        <h1 class="text-4xl md:text-5xl lg:text-7xl font-black mb-4 tracking-tight drop-shadow-md">Fasilitas Kawasan Premium</h1>
        <p class="text-slate-400 text-base md:text-lg max-w-2xl">Kami merancang Graha Land Serang tidak hanya sebagai tempat berteduh, melainkan komunitas sosial terpadu yang menunjang segala aktivitas dan kenyamanan keluarga Anda secara paripurna.</p>
    </div>
</div>
